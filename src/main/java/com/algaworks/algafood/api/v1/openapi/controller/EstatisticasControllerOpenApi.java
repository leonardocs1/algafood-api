...
public interface EstatisticasControllerOpenApi {
	...
	@Operation(summary = "Consulta estatísticas de vendas diárias", parameters = {
			...
			@Parameter(in = ParameterIn.QUERY, name = "dataCriacaoFim", description = "Data/hora final da criação do pedido", example = "2019-12-02T23:59:59Z", schema = @Schema(type = "string", format = "date-time")) }, responses = {
