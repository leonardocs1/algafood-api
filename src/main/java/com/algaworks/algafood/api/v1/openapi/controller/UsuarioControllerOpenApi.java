...
public interface UsuarioControllerOpenApi {
	...
	UsuarioModel adicionar(@ApiParam(name = "corpo", value = "Representação de um usuário", required = true) UsuarioComSenhaInput usuarioInput);
	...
	void atualizarSenha(@ApiParam(value = "ID de um usuário", example = "1", required = true) Long usuarioId, 
			@ApiParam(name = "corpo", value = "Representa uma nova senha", required = true) SenhaInput senhaInput);
}
