...
public class FormaPagamentoController {
	...
	public FormaPagamentoModel atualizar(@PathVariable Long formaPagamentoId,
		...
		FormaPagamento formaAtual = cadastroFormaPagamento.buscarOuFalhar(formaPagamentoId);

		formaPagamentoInputDisassembler.copyToDomainObject(formaPagamentoInput, formaAtual);

		return formaPagamentoModelAssembler.toModel(cadastroFormaPagamento.salvar(formaAtual));
	}
