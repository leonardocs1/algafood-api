...
public interface GrupoControllerOpenApi {
	...
	public GrupoModel atualizar(@ApiParam(value = "ID de um grupo", required = true) Long grupoId, 
	...
	public void deletar(@ApiParam(value = "ID de um grupo", example = "1", required = true) Long grupoId);
}
